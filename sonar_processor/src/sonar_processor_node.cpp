...
sonar_msgs::sonar_processed_data createMsg(rangeAndAngle rangeAndAngles) {
    // Necesarry variables
...
void sonarProcessor::sonarCallback(const sonar_msgs::sonar_raw_data::ConstPtr& msg) {
    ...
    msgToBePublished = createMsg(rangeAndAngles);
...
slik at man ikke manuelt må legge de inn i /usr/lib for det suger
*/
